...
public class PessoaDao extends Dao {
	...
	public boolean alterarPessoa(Pessoa p) throws Exception {
		...
		stmt.execute();
		// Abaixo se der erro na busca ao banco de dados ele trata o erro em catch	
		...
		//Se deu certo ele retorna true, e vai para classe Menu (if), e Pessoa alterada com sucesso
		stmt.close(); 
		close();
		return true;
